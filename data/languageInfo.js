  ...
  info: [
    {
      ...
      interview_rounds: {
        ...
        algo: "These are 45 minute interviews where the interviewer shares a Google Doc with the candidate and asks Medium to Hard problems of Algorithms and DS. It is expected that the candidate first explains the solution of the problem to the interviewer and then codes the problem on google doc within the time of the interview.",
        googliness:
          "This is a new interview which Google started in 2020. It’s mostly the behavioral interview to check the cultural fitness of the candidate in the company.",
      },
      faq: "",
    },
  ],
