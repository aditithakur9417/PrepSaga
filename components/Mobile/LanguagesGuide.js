...
import styles from "../../styles/Mobile/LanguagesGuide.module.scss";
      ...
      <div className={styles.languageContainer}>
        ...
        <div className={styles.boxModel}>
          <a className={styles.clickable}>
            <div className={styles.logoContainer}>
              <img
                src="https://2s7gjr373w3x22jf92z99mgm5w-wpengine.netdna-ssl.com/wp-content/uploads/2018/02/code_shutterstock_Vintage-Tone-300x200.jpg"
                className={styles.logoImage}
                alt="logo"
              />
            </div>
